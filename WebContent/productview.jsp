...
<%
	...
	CartBean cartMap = (CartBean) request.getAttribute("cart");
	if(cartMap==null){
    ...
    <div class="col-sm-12 col-md-10 col-md-offset-1">
        <table class="table table-hover">
            ...
            for(CartItem x : cartMap.getItems())
            {
            	...
            	subtotal=subtotal.add(var.getDiscountedPrice().multiply(BigDecimal.valueOf(cartMap.getQuantity(x))));
            %>
                <tr>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading"><a href="<%=request.getContextPath()%>/product_detail?prod=<%=prod.getId()%>"><%=prod.getTitle()%></a></h4>
                            <span>Status: </span><span class="text-success"><strong><%=cartMap.getQuantity(x) %></strong></span>
                    ...
                    <td class="col-sm-1 col-md-1 text-center"><strong><%=var.getDiscountedPrice().multiply(BigDecimal.valueOf(cartMap.getQuantity(x)))%></strong></td>
                    ...
                    <button type="button" class = "btn btn-danger">Remove
                        <span class="glyphicon glyphicon-remove"></span> 
                                ...
                                <%} %>
                   <!--   <button type="button" class="btn btn-danger" onclick = "<%cartMap.remove(x);%>">
                ...
                <tr>
                    ...
                    <td class="text-right"><h5><strong><%=estimatedShip(subtotal)%></strong></h5></td>
                </tr>
                <tr>
                    <td>   </td>
                    <td>   </td>
                    <td>   </td>
                    <td><h3>Total</h3></td>
                    <td class="text-right"><h3><strong><%=subtotal.add(estimatedShip(subtotal))%></strong></h3></td>
                </tr>
                <tr>
                    <td>   </td>
                    <td>   </td>
